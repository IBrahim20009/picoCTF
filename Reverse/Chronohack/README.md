...
## 🛠 Exploit Script Behavior

The script:

* Computes one‑way network delay using a dummy guess
...
├── token_generator.py      # challenge source code
...
* Python’s `random` module is **not secure** for cryptographic purposes
